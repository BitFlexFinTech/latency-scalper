...
export class OrderManager {
  ...
  async closePosition(positionId: string): Promise<void> {
    ...
    // CRITICAL FIX: Legacy code removed - new bot writes directly to trade_logs in TradingEngine
    // This OrderManager is legacy and should not insert trades
    // The new bot's TradingEngine handles all trade logging
